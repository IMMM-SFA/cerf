...
class InstallSupplement:
    ...
    DATA_VERSION_URLS = {'1.0.0': 'https://zenodo.org/record/3629645/files/example.zip?download=1',
                         '2.0.0': 'https://zenodo.org/record/3629645/files/example.zip?download=1'}
