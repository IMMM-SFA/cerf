...
# ADD CPP /nologo /G5 /MD /W3 /GX /O2 /I "$(GDAL)/include" /I "$(GDAL)/gcore" /I "$(GDAL)/port" /I "$(GDAL)/ogr" /I "$(GDAL)/ogr/ogrsf_frmts" /I "$(SAGA)/src/saga_core" /D "NDEBUG" /D "WIN32" /D "_USRDLL" /D "_MBCS" /D "_TYPEDEF_BYTE" /D "_TYPEDEF_WORD" /D "_SAGA_MSW" /D "_SAGA_VC" /YX /FD /c
...
# ADD CPP /nologo /MDd /W3 /Gm /GX /ZI /Od /I "$(GDAL)/port" /I "$(GDAL)/include" /I "$(GDAL)/gcore" /I "$(GDAL)/ogr" /I "$(GDAL)/ogr/ogrsf_frmts" /I "$(SAGA)/src/saga_core" /D "_DEBUG" /D "WIN32" /D "_USRDLL" /D "_MBCS" /D "_TYPEDEF_BYTE" /D "_TYPEDEF_WORD" /D "_SAGA_MSW" /D "_SAGA_VC" /YX /FD /GZ /c
# SUBTRACT CPP /Fr
...
# ADD CPP /nologo /MDd /W3 /Gm /GX /ZI /Od /I "$(GDAL)/port" /I "$(GDAL)/include" /I "$(GDAL)/gcore" /I "$(GDAL)/ogr" /I "$(GDAL)/ogr/ogrsf_frmts" /I "$(SAGA)/src/saga_core" /D "_USRDLL" /D "_MBCS" /D "_SAGA_VC" /D "_DEBUG" /D "WIN32" /D "_UNICODE" /D "_TYPEDEF_BYTE" /D "_TYPEDEF_WORD" /D "_SAGA_MSW" /D "_SAGA_UNICODE" /YX /FD /GZ /c
# SUBTRACT CPP /Fr
# ADD BASE MTL /nologo /D "_DEBUG" /mktyplib203 /win32
# ADD MTL /nologo /D "_DEBUG" /mktyplib203 /win32
...
# ADD CPP /nologo /G5 /MD /W3 /GX /O2 /I "$(GDAL)/port" /I "$(GDAL)/include" /I "$(GDAL)/gcore" /I "$(GDAL)/ogr" /I "$(GDAL)/ogr/ogrsf_frmts" /I "$(SAGA)/src/saga_core" /D "NDEBUG" /D "_USRDLL" /D "_MBCS" /D "_SAGA_VC" /D "WIN32" /D "_UNICODE" /D "_TYPEDEF_BYTE" /D "_TYPEDEF_WORD" /D "_SAGA_MSW" /D "_SAGA_UNICODE" /YX /FD /c
# ADD BASE MTL /nologo /D "NDEBUG" /mktyplib203 /win32
# ADD MTL /nologo /D "NDEBUG" /mktyplib203 /win32
