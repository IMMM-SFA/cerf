...
.. panels::
    ...
    key concepts of **cerf** with useful background information and explanation.
    ...
    the **cerf** API. The reference describes how the methods work and which parameters can
